<template>
    <jet-form-section @submitted="updateProfileInformation">
        ...
        <template #description>
            در این قسمت میتوانید نام، تلفن تماس و آدرس ایمیل خود را بروزرسانی نمایید.
        </template>
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4" v-if="$page.jetstream.managesProfilePhotos">
                ...
                <jet-label for="photo" value="تصویر پروفایل" />
            ...
            <!-- Mobile -->
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="mobile" value="تلفن تماس" />
            ...
            <!-- Email -->
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="email" value="آدرس ایمیل" />
