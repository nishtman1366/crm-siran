...
Route::middleware(['auth:sanctum', 'verified'])
    ...
    ->namespace('App\\Http\\Controllers')->group(function () {
        ...
        Route::prefix('roles')->middleware('role:superuser')->name('roles.')->namespace('Users')->group(function () {
            ...
            Route::post('{roleId}', 'RoleController@permissions')->name('permissions');
        });

        Route::prefix('permissions')->middleware('role:superuser')->name('permissions.')->namespace('Users')->group(function () {
            Route::get('', 'PermissionController@index')->name('list');
            Route::post('', 'PermissionController@store')->name('store');
            Route::put('{permissionId}', 'PermissionController@update')->name('update');
            Route::delete('{permissionId}', 'PermissionController@destroy')->name('destroy');
        });
